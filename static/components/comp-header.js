...
templateCompHeader.innerHTML = `
    <style>
        ...
        .header{
            ...
            display: grid;
            grid-template-columns: 0 auto 1fr auto auto auto auto auto 0;
            gap: 2.5vh;
            z-index: 9;
        }
            .logo{
    ...
    <div class="header shadow">
        ...
        <a href="https://discord.gg/QtbRGDAxSk" target="_blank">
            <img class="icon highlight" src="/static/content/svg/svg-discord.svg">
        </a>
