const templateDL = document.createElement("template");
templateDL.innerHTML = `
    <style>
    a{
    ...
    <a id="project" href="" target="_blank">
...
class CompDL extends HTMLElement{
    constructor(){
        super();
        this.attachShadow({mode: "open"});
        this.shadowRoot.appendChild(templateDL.content.cloneNode(true));
...
window.customElements.define("comp-dl", CompDL);
